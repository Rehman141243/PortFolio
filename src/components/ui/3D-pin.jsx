...
export const  PinContainer = ({
  ...
  return (
    <a
      className={cn("relative group/pin z-50  cursor-none", containerClassName)}
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 " style={{fontFamily:'Poppins', }}>
            <span
              className="relative z-20 text-white text-xs font-bold inline-block py-0.5" style={{fontFamily:'Poppins'}}>
              {title}
            </span>
