  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        className={
          "min-w-max rounded-full bg-neutral-200 px-2 py-2 text-xs whitespace-nowrap text-white text-bold"
        }>
        {title || <img src="/unnamed.jpg" style={{width:26, height:26, borderRadius:50}}/>}
      </motion.div>
    </motion.div>
  );
};
